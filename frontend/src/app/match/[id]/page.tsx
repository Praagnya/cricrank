...
import { Match, MatchScorecard } from "@/types";
            ...
            <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4">
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="text-center">
                  ...
                  {scorecard?.score.find(s => s.inning.toLowerCase().startsWith(match.team1.toLowerCase())) && (() => {
                    const s = scorecard.score.find(s => s.inning.toLowerCase().startsWith(match.team1.toLowerCase()))!;
                    return <p className="font-gaming text-lg font-black text-white mt-1 tabular-nums">{s.r}/{s.w} <span className="text-xs text-[#525252]">({s.o})</span></p>;
                  })()}
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="text-center">
                  ...
                  {scorecard?.score.find(s => s.inning.toLowerCase().startsWith(match.team2.toLowerCase())) && (() => {
                    const s = scorecard.score.find(s => s.inning.toLowerCase().startsWith(match.team2.toLowerCase()))!;
                    return <p className="font-gaming text-lg font-black text-white mt-1 tabular-nums">{s.r}/{s.w} <span className="text-xs text-[#525252]">({s.o})</span></p>;
                  })()}
                </div>
              </div>
